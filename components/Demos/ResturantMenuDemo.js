...
const ResturantMenuDemo = ({ title }) => {
  ...
  return (
    <div>
      <Title title={title} />
      <StyledResturantMenuDemo className="p-2 shadow-sm">
      ...
      <iframe
        src="https://codesandbox.io/embed/react-tabs-scrollable-restaurant-menu-example-8l7q6v?fontsize=14&hidenavigation=1&theme=dark"
        style={{
          width: "100%",
          height: "500px",
          border: 0,
